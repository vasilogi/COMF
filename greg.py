...
print('')
print('+---------------------------------+')
print('| Regression in the integral rate |')
print('+---------------------------------+')
...
for Csv_i, Csv in enumerate(Csvs):
    ...
    OUTPUT    = os.path.join(OUTPUT,'greg_blim_'+str(b_lim)+'_ulim_'+str(u_lim)) # output directory for the data regarding the conversion
